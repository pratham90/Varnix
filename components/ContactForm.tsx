...
const ContactForm = () => {
  return (
   <section className="w-full flex flex-col md:flex-row justify-center gap-8 md:gap-12 lg:gap-15 items-start md:items-center py-8 sm:py-10 md:py-12 lg:py-14 px-4 sm:px-6 md:px-8 lg:px-16 bg-pink-50 text-black">
      <div className='w-full md:w-1/3 flex flex-col justify-start  items-start gap-6 sm:gap-8 md:gap-12 lg:gap-31'>
        <em className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-gray-700">Contact Us</em>
      ...
      <button
        ...
        <form className="flex flex-col gap-4 sm:gap-5 md:gap-6 w-full">
          ...
          <button
            type="submit"
            className="bg-pink-500 text-white w-1/3 lg:px-2 lg:w-1/5 lg:py-1  px-2 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 text-sm sm:text-base md:text-lg rounded-xl hover:bg-pink-600 transition mt-2"
          >
            submit
          </button>
        </form>
